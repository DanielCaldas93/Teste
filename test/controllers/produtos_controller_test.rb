...
class ProdutosControllerTest < ActionController::TestCase
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post :create, produto: { descricao: @produto.descricao, imagem: @produto.imagem, nome: @produto.nome, quantidade: @produto.quantidade, valorUnit: @produto.valorUnit }
    end
  ...
  test "should update produto" do
    patch :update, id: @produto, produto: { descricao: @produto.descricao, imagem: @produto.imagem, nome: @produto.nome, quantidade: @produto.quantidade, valorUnit: @produto.valorUnit }
    assert_redirected_to produto_path(assigns(:produto))
  end
